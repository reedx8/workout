        ...
        <main>
            ...
            <section className='flex gap-6 p-8 bg-[var(--color-myRedBg)] w-full h-90'>
                ...
                <div className='flex flex-col gap-2 w-1/2'>
                    ...
                    <button className='flex gap-2 items-center cursor-pointer'>
                        <p
                            className={`${headlineFont2.className} text-black text-3xl`}
                        >
            ...
            <section className='flex flex-col gap-6 bg-white w-full py-20 px-10'>
                ...
                <div className='flex gap-6 w-full'>
                    ...
                    <div className='w-6/10 bg-[var(--color-myRedBg)] p-6 flex flex-col gap-4'>
                        ...
                        <div className='bg-black/30 h-0.25 w-full'></div>
                        <p className='text-xl'>
                            After you fill out the form at the bottom of this
                            page, you’ll receive a pre-screening text and email
                            with a few quick questions about the basic
                            requirements to become a manager. This helps us
                            determine your eligibility before moving forward in
                            the hiring process.
                        </p>
                    </div>
                </div>
